...
* **StreamForge — Video Streaming Platform**
  Full-stack video streaming platform built with **Spring Boot, React & MySQL**, featuring HTTP byte-range streaming for efficient video playback and seeking.
  → https://github.com/malewarpallavi/StreamForge

* **Secure File Transfer Simulation**
  Windows systems-programming project using **C++ & Win32 API**, with file encryption/decryption and cryptographic logic packaged into a reusable DLL.
